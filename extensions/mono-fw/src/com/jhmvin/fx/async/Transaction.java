...
public abstract class Transaction {
    ...
    private static boolean errorApprehension = false;

    public static void setErrorApprehension(boolean errorApprehension) {
        Transaction.errorApprehension = errorApprehension;
    }
                    ...
                    if (errorApprehension) {
                        if (e instanceof TransactionException) {
                            ...
                            if (Thread.getDefaultUncaughtExceptionHandler() != null) {
                                System.out.println("Has Default Thread");
                                Thread.getDefaultUncaughtExceptionHandler().uncaughtException(supportThread, e);
                            } else {
                                System.out.println("No Default Thread");
                            }
                        }
                    } else {
                        System.out.println("No Aprrehended");
                    }
                    //----------------------------------------------------------
