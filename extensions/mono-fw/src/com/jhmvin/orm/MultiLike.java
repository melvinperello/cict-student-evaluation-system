...
public class MultiLike implements Criterion {
     ...
     */
    public MultiLike(String value, MatchMode match, String... columns) {
    ...
    /**
     * This methods generate the SQL String from the criteria. This methods gets
     * the hibernate properties, and translate them into database columns.
    ...
    public static MultiLike ilike(String value, MatchMode match, String... columns) {
        return new MultiLike(value, match, columns);
    }
}
