...
import org.cict.configuration.PublicConstants;
...
// construct
    ...
    private MonoModels tbl_backup_logs;
    private MonoModels tbl_backup_schedule;
...
// mapping information
        ...
        Mono.orm().addMappings("BackupLogsMapping");
        this.tbl_backup_logs = Mono.orm().createModel(BackupLogsMapping.class);
        Mono.orm().addMappings("BackupScheduleMapping");
        this.tbl_backup_schedule = Mono.orm().createModel(BackupScheduleMapping.class);
    ...
    public MonoModels backup_logs() {
        return tbl_backup_logs;
    }

    public MonoModels backup_schedule() {
        return tbl_backup_schedule;
    }
