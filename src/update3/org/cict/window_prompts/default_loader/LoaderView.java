...
public class LoaderView extends SceneFX {
    ...
    public void attach() {
        this.stackPane.getChildren().remove(this.loadingBox);
         ...
         */
        this.loadingBox.prefWidthProperty().bind(this.stackPane.widthProperty());
        this.loadingBox.maxWidthProperty().bind(this.stackPane.maxWidthProperty());
        this.loadingBox.minWidthProperty().bind(this.stackPane.minWidthProperty());
        /**
         * Bind height to parent.
         */
        this.loadingBox.prefHeightProperty().bind(this.stackPane.heightProperty());
        this.loadingBox.maxHeightProperty().bind(this.stackPane.maxHeightProperty());
        this.loadingBox.minHeightProperty().bind(this.stackPane.minHeightProperty());
    }
