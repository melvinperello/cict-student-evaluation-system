...
public class RequisitesTracker {
    ...
    public static ArrayList<Integer> viewRequisites(ArrayList<CurriculumRequisiteLineMapping> starting_list, StudentMapping studentMap) {
        Integer cict_id = studentMap.getCict_id();
        //
        ...
        while (current_iterator.hasNext()) {
            ...
            ArrayList<CurriculumRequisiteLineMapping> a = listRequisites(current_iteration, studentMap);
    ...
    public static ArrayList<CurriculumRequisiteLineMapping> listRequisites(Integer id, StudentMapping studentMap) {
