...
public class ProfileReader {
    ...
    private final static String file = "C:\\Users\\Jhon Melvin\\Desktop\\EMS-CICT-PROFILE\\BSIT 4\\4H-G2.xlsx";
    private final static Integer curriculum_id = 13; // curriculum
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // assign the file
            ArrayList<ProfileReader.ProfileObject> profileList = reader.read(file);
            //------------------------------------------------------------------
    ...
    /**
     * Inner static class to hold the data of this reader.
     */
