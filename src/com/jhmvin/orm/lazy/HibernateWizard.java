...
public class HibernateWizard {
    ...
    private void headers() {
        ...
        writejv("// Mono Models");
        writejv("// Monosync Framewrok v1.8.x");
    ...
    private void prologue() {
        ...
        writejv("public class " + className + " implements java.io.Serializable {");
    }
    ...
    private void db_setup() {
        ...
        writedb("Mono.orm().setC3p0_min(0);");
        writedb("Mono.orm().setC3p0_timeout(10);");
