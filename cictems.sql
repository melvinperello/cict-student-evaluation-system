...
) ENGINE=InnoDB AUTO_INCREMENT=2923 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=2729 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `linked_pila` (
  ...
  `conforme` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `course` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `imei` varchar(80) COLLATE utf8_unicode_ci DEFAULT NULL,
  `request_accepted` datetime DEFAULT current_timestamp(),
  `request_called` datetime DEFAULT NULL,
  `called_by` varchar(100) COLLATE utf8_unicode_ci DEFAULT '',
  `called_on_terminal` varchar(100) COLLATE utf8_unicode_ci DEFAULT '',
...
-- Dumping structure for table cictems.retention_policy
CREATE TABLE IF NOT EXISTS `retention_policy` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `STUDENT_id` int(11) DEFAULT NULL,
  `section` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `CURRICULUM_id` int(11) DEFAULT NULL,
  `year_level` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `prev_school_year` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `prev_semester` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `academic_year` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `academic_semester` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `verification_date` datetime DEFAULT current_timestamp(),
  `verified_by` int(11) DEFAULT NULL,
  `active` tinyint(4) DEFAULT 1,
  PRIMARY KEY (`id`),
  KEY `retention_policy_student_id` (`STUDENT_id`),
  KEY `retention_policy_curriculum_id` (`CURRICULUM_id`),
  KEY `retention_policy_verified_by` (`verified_by`),
  CONSTRAINT `retention_policy_curriculum_id` FOREIGN KEY (`CURRICULUM_id`) REFERENCES `curriculum` (`id`),
  CONSTRAINT `retention_policy_student_id` FOREIGN KEY (`STUDENT_id`) REFERENCES `student` (`cict_id`),
  CONSTRAINT `retention_policy_verified_by` FOREIGN KEY (`verified_by`) REFERENCES `faculty` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Data exporting was unselected.

-- Dumping structure for table cictems.retention_subject
CREATE TABLE IF NOT EXISTS `retention_subject` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `retention_id` int(11) DEFAULT NULL,
  `subject_code` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `subject_title` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `units` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `active` tinyint(4) DEFAULT 1,
  PRIMARY KEY (`id`),
  KEY `retention_subject` (`retention_id`),
  CONSTRAINT `retention_subject` FOREIGN KEY (`retention_id`) REFERENCES `retention_policy` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
